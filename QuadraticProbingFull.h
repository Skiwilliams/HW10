#ifndef QUADRATICPROBINGFULL_H
#define QUADRATICPROBINGFULL_H
...
template <typename HashedObj> class QuadraticHashTableFull {
public:
  explicit QuadraticHashTableFull(int size = 101) : array(nextPrime(size)) {
    makeEmpty();
    collisions = 0;
