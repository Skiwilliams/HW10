#ifndef QUADRATICPROBINGPREFIX_H
#define QUADRATICPROBINGPREFIX_H
...
template <typename HashedObj> class QuadraticHashTablePrefix {
public:
  explicit QuadraticHashTablePrefix(int size = 101) : array(nextPrime(size)) {
    makeEmpty();
    collisions = 0;
