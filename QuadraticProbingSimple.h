#ifndef QUADRATICPROBINGSIMPLE_H
#define QUADRATICPROBINGSIMPLE_H
...
template <typename HashedObj> class QuadraticHashTableSimple {
public:
  explicit QuadraticHashTableSimple(int size = 101) : array(nextPrime(size)) {
    makeEmpty();
    collisions = 0;
